...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            // dd($input, isset($input['company_id']), auth()->user()->company_id);
            ...
            if ($request->role === 'admin') {
                ...
                $patientPermissions = config('roles_permissions.patient');
                $user->syncPermissions($patientPermissions);

            } elseif ($request->role === 'medecin') {

                $medecinPermissions = config('roles_permissions.medecin');
                $user->syncPermissions($medecinPermissions);
