                        ...
                        <div class="card-header">
                            <div class=" flex justify-content-between align-items-center">
                                <a href="#" type="button" data-toggle="modal" data-target="#new-cat"
                                    class="btn bg-gradient-primary btn-sm" title="Nouvelle catégorie">
                        ...
                        <div class="card-body table-responsive p-0">
                            <table class="table table-hover text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="2" style="text-align: center">Aucun catégorie enregistré</td>
                                        </tr>
                                    @endforelse
                        ...
                        <div class="modal fade" id="new-cat" data-backdrop="static" data-keyboard="false">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('category.store') }}" method="POST" id="formCat">
                                        <div class="modal-body">
                                            <div class="row">
                                                @csrf
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="cat_name">Nom de la catégorie <em class="text-danger">*</em></label>
