...
<div class="row" id="part2">
    ...
    <div class="col-md-4">
        <div class="form-group">
            <label for="doc">Numéro de pièce d'identité</label>
            <input type="text" class="form-control" id="doc" name="document_number"
                value="{{ old('document_number', $patient->document_number ?? '') }}">
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
            <label for="ft">Prénom et nom du père</label>
            <input type="text" class="form-control" id="ft" name="father_name"
                value="{{ old('father_name', $patient->father_name ?? '') }}">
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
            <label for="jb">Profession</label>
            <input type="text" class="form-control" id="jb" name="job"
    ...
    <div class="col-md-4">
        <div class="form-group">
            <label for="oth">Autre niveau d'étude</label>
            <input type="text" class="form-control" id="oth" name="other_level_study"
                value="{{ old('other_level_study', $patient->other_level_study ?? '') }}">
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
            <label for="ag">Age du conjoint(e)</label>
            <input type="text" class="form-control" id="ag" name="spouce_age"
                value="{{ old('spouce_age', $patient->spouce_age ?? '') }}">
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
            <label for="prof">Profession du conjoint(e)</label>
            <input type="text" class="form-control" id="prof" name="spouce_job"
                value="{{ old('spouce_job', $patient->spouce_job ?? '') }}">
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
            <label for="nt">Nationalité</label>
            <input type="text" class="form-control" id="nt" name="nationality"
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="emp" name="employer"
                value="{{ old('employer', $patient->employer ?? '') }}">
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
            <label for="ref">Référence interne</label>
            <input type="text" class="form-control" id="ref" name="inter_reference"
