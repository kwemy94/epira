<div class="row">
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="text" class="form-control required" id="name" name="lastname" autofocus>
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
            <label for="pname">Prénom</label>
            <input type="text" class="form-control" id="pname" name="firstname" placeholder="">
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="date" class="form-control required" id="dat" name="birth_date" placeholder="">
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
            <label for="datl">Lieu de naissance</label>
            <input type="text" class="form-control" id="datl" name="birth_place" placeholder="">
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="datl" name="mother_name" placeholder="">
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
            <label for="datl">Nom de jeune fille</label>
            <input type="text" class="form-control" id="datl" name="maiden_name" placeholder="">
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="datl" name="phone" placeholder="">
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
            <label for="datl">Autre numéro</label>
            <input type="text" class="form-control" id="datl" name="other_phone" placeholder="">
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
            <label for="datl">Email</label>
            <input type="email" class="form-control" id="datl" name="email" placeholder="">
        </div>
    </div>
