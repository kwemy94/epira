...
@section('admin-content')
    ...
    <div class="section">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="card-header p-0 border-bottom-0 mb-2 ml-2">
                        <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                            <li class="nav-item">
                                <a class="btn btn-info active" target="_blank" href="{{ route('dossier.patient', $patient->id) }}" role="tab">
                                    Télécharger dossier médicale
                                </a>
                            </li>
                        </ul>
                    </div>
