<div class="modal fade" id="createEtablissementModal" tabindex="-1" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg">
        <form method="POST" action="{{ route('company.store') }}" id="formEtablissement">
            @csrf

            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
                        <i class="fas fa-building mr-1"></i> Nouvelle structure
                    </h5>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Nom de la structure <em class="text-danger">*</em></label>
                ...
                <div class="modal-footer bg-light">
                    ...
                    <button type="submit" class="btn btn-primary btn-sm" id="saveEtablissementBtn">
                        Enregistrer
                    </button>
                </div>
            </div>
