...
@section('admin-content')
    <x-page-header title="Nouvelle ambulance" :breadcrumbs="[
        [
            'label' => 'Prestation',
            'url' => route('prestation.index'),
        ],
        ['label' => 'Nouvelle ambulance'],
    ]" />
                        ...
                        @csrf
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="enter_date">Date d'entrée<em style="color:red">*</em></label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="exit_date">Date de sortie<em style="color:red">*</em></label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="type_ambulance">Type d'ambulance</label>
                                    <select name="type_ambulance" id="type_ambulance" class="form-control @error('type_ambulance') is-invalid @enderror">
                                        <option value="">-- Sélectionner --</option>
                                        @foreach ($type_ambulances as $type_ambulance )
                                            <option value="{{$type_ambulance->id}}">{{$type_ambulance->type}}</option>                                            
                                        @endforeach                                      
                                    </select>
                                    @error('type_ambulance')<span class="invalid-feedback">{{ $message }}</span>@enderror
                                </div>
                            </div>
                             <div class="col-md-4">
                                <div class="form-group">
