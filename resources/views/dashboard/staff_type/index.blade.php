                        ...
                        <div class="card-header">
                            <div class=" flex justify-content-between align-items-center">
                                <a href="#" type="button" data-toggle="modal" data-target="#new-cat"
                                    class="btn bg-gradient-primary btn-sm" title="Nouveau">
                        ...
                        <div class="modal fade" id="new-cat" data-backdrop="static" data-keyboard="false">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('staff-type-host.store') }}" method="POST" id="formCat">
                                        <div class="modal-body">
                                            <div class="row">
                                                @csrf
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="cat_name">Nom <em class="text-danger">*</em></label>
